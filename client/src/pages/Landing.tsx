      ...
      <div>
        ...
        <div className="md:grid grid-cols-3 bg-slate-50 xl:px-24 items-center">
          <div className="flex flex-col p-12 gap-6 flex-2 col-span-2">
            ...
            <p className="font-medium text-slate-500">
              Deliver stunning images to your vendors fast and easy with our
              app. They will love seeing their work and share your work with new
              clients. Collect vendor information in a snap and tag them on
              social media with one click. No hassle, no delay, just more
              exposure and more bookings.
            </p>
            <Link to={'/register'}>
        ...
        <div className="flex flex-col-reverse py-12 items-center md:grid md:grid-cols-2 lg:grid-cols-3 xl:px-24 gap-14">
          ...
          <div className="flex flex-col gap-4 items-center px-6 text-center md:items-start md:text-left lg:col-span-2">
            ...
            <p className="font-medium text-slate-500">
              As the client types in the form, a dropdown box provides a
              filtered list of vendors already in your database. One click and
              the remainder of the details are completed.
            </p>
            <p className="font-medium text-slate-500">
        ...
        <div className="flex flex-col py-12 items-center md:grid lg:grid-cols-2 xl:px-24 gap-14">
          <div className="flex flex-col gap-4 items-center px-6 text-center lg:items-start lg:text-left lg:col-span-1">
            ...
            <p className="font-medium text-slate-500">
              Filter through client submissions by name, then view all the
              details of the event on one page.
            </p>
            <ul className="p-4 list-disc flex flex-col gap-4 text-left text-">
              ...
              <li className="">
                'Copy for Email' copies a string of all the comma separate
                vendor emails, ready to paste in to your email or image gallery
                provider of choice.
              </li>
            </ul>
          </div>
